                      ...
                      return (
                            <div className="min-h-screen bg-gray-50 flex">
                                  <div className="w-56 bg-white border-r flex flex-col fixed h-full z-10 shadow-sm">
                                          <div className="p-4 border-b"><div className="flex items-center gap-2"><div className="w-8 h-8 bg-blue-600 rounded flex items-center justify-center text-white text-sm font-bold">\u5546</div>div><div><div className="text-sm font-bold">\u5546\u6d41OS</div>div><div className="text-xs text-gray-400">\u767a\u6ce8\u8005\u30c0\u30c3\u30b7\u30e5\u30dc\u30fc\u30c9</div>div></div>div></div>div></div>div>
                                          <nav className="flex-1 p-3 space-y-1">
                                                    ...
                                                    <Link href="#" className="block px-3 py-2 rounded text-sm text-gray-600 hover:bg-gray-100">\u2605 \u3044\u3064\u3082\u306e\u767a\u6ce8</Link>Link>
                                          </nav>nav>
                                  ...
                                  <div className="ml-56 flex-1 p-6">
                                          ...
                                          <div className="grid grid-cols-4 gap-4 mb-6">
                                                    ...
                                                    <div className="bg-purple-50 rounded-xl shadow-sm p-4 border border-purple-100"><div className="text-xs text-gray-500 mb-1">\uffe5 \u4eca\u6708\u306e\u8acb\u6c42\u91d1\u984d</div>div><div className="text-lg font-bold">\uffe5{total.toLocaleString()}</div>div><div className="text-xs text-gray-400">({new Date().getMonth() + 1}\u6708\u5206)</div>div></div>div>
                                          </div>div>
                                                    ...
                                                    <div className="space-y-4">
                                                                ...
                                                                <div className="bg-white rounded-xl shadow-sm p-5">
                                                                              ...
                                                                              <div className="space-y-2">
                                                                                              <Link href="/orders/new" className="flex items-center justify-between p-3 border rounded-lg hover:bg-gray-50 text-sm"><span>\u2605 \u3044\u3064\u3082\u306e\u767a\u6ce8\u3092\u3059\u308b</span>span><span>\u203a</span>span></Link>Link>
                                                                                              <Link href="#" className="flex items-center justify-between p-3 border rounded-lg hover:bg-gray-50 text-sm"><span>\ud83d\udcdc \u8acb\u6c42\u66f8\u3092\u30c0\u30a6\u30f3\u30ed\u30fc\u30c9</span>span><span>\u203a</span>span></Link>Link>
                                                                              </div>div>
                                                                </div>div>
                                                                <div className="bg-white rounded-xl shadow-sm p-5">
