                                  ...
                                  <div className="ml-56 flex-1 p-6">
                                          ...
                                          <div className="grid grid-cols-3 gap-6">
                                                    <div className="col-span-2 bg-white rounded-xl shadow-sm p-5">
                                                                <div className="flex items-center justify-between mb-4"><h2 className="font-semibold text-gray-800">\u767a\u6ce8\u4e00\u89a7</h2>h2><Link href="/orders" className="text-sm text-blue-500">\u3059\u3079\u3066\u898b\u308b &gt;</Link>Link></div>
                                                    ...
                                                    <div className="space-y-4">
                                                                ...
                                                                <div className="bg-white rounded-xl shadow-sm p-5">
                                                                              ...
                                                                              <div className="space-y-2">
                                                                                              <Link href="/orders/new" className="flex items-center justify-between p-3 border rounded-lg hover:bg-gray-50 text-sm"><span>\u2605 \u3044\u3064\u3082\u306e\u767a\u6ce8\u3092\u3059\u308b</span><span>\u203a</span></Link>Link>
                                                                                              <Link href="#" className="flex items-center justify-between p-3 border rounded-lg hover:bg-gray-50 text-sm"><span>\ud83d\udcdc \u8acb\u6c42\u66f8\u3092\u30c0\u30a6\u30f3\u30ed\u30fc\u30c9</span><span>\u203a</span></Link>Link>
                                                                              </div>
                                                                </div>
                                                                <div className="bg-white rounded-xl shadow-sm p-5">
