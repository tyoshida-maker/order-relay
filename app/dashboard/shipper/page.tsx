...
export default function ShipperDashboard() {
  ...
  const badge = (s: string) => {
        if (s === 'shipped') return <span className="px-2 py-0.5 rounded-full text-xs bg-blue-100 text-blue-700">\u767a\u9001\u6e08</span>span>
              if (s === 'approved') return <span className="px-2 py-0.5 rounded-full text-xs bg-yellow-100 text-yellow-700">\u672a\u51fa\u8377</span>span>
              if (s === 'completed') return <span className="px-2 py-0.5 rounded-full text-xs bg-green-100 text-green-700">\u7d0d\u54c1\u5b8c\u4e86</span>span>
              return <span className="px-2 py-0.5 rounded-full text-xs bg-orange-100 text-orange-700">\u51fa\u8377\u6e96\u5099\u4e2d</span>span>
          }
                  ...
                  return (
                        <div className="min-h-screen bg-gray-50 flex">
                              <div className="w-56 bg-white border-r flex flex-col fixed h-full z-10 shadow-sm">
                                      <div className="p-4 border-b"><div className="flex items-center gap-2"><div className="w-8 h-8 bg-blue-600 rounded flex items-center justify-center text-white text-sm font-bold">\u5546</div>div><div><div className="text-sm font-bold">\u5546\u6d41OS</div>div><div className="text-xs text-gray-400">\u767a\u9001\u8005\u30c0\u30c3\u30b7\u30e5\u30dc\u30fc\u30c9</div>div></div>div></div>div></div>div>
                                      <nav className="flex-1 p-3 space-y-1">
                                                <div className="px-3 py-2 bg-blue-50 text-blue-700 rounded text-sm font-medium">\ud83c\udfe0 \u30db\u30fc\u30e0</div>div>
                              ...
                              <div className="ml-56 flex-1 p-6">
                                      <div className="flex items-center justify-between mb-6">
                                                ...
                                                <div className="flex items-center gap-2 bg-white border rounded-lg px-3 py-2 text-sm">\ud83d\udc64 {userName}</div>div>
                                      </div>div>
                                      <div className="grid grid-cols-3 gap-4 mb-6">
                                                <div className="bg-white rounded-xl shadow-sm p-4 border-l-4 border-blue-500"><div className="text-xs text-gray-500">\ud83d\ude9a \u4eca\u65e5\u306e\u51fa\u8377\u4ef6\u6570</div>div><div className="text-3xl font-bold mt-1">{active.length}<span className="text-sm font-normal text-gray-500 ml-1">\u4ef6</span>span></div>div><div className="text-xs text-gray-400">(\u51fa\u8377\u6e08 {shipped}\u4ef6)</div>div></div>div>
                                                <div className="bg-white rounded-xl shadow-sm p-4 border-l-4 border-orange-500"><div className="text-xs text-gray-500">\ud83d\udce6 \u672a\u51fa\u8377\u4ef6\u6570</div>div><div className="text-3xl font-bold mt-1">{unshipped}<span className="text-sm font-normal text-gray-500 ml-1">\u4ef6</span>span></div>div><div className="text-xs text-gray-400">(\u8981\u5bfe\u5fdc)</div>div></div>div>
                                                <div className="bg-white rounded-xl shadow-sm p-4 border-l-4 border-green-500"><div className="text-xs text-gray-500">\u2705 \u51fa\u8377\u6e08</div>div><div className="text-3xl font-bold mt-1">{shipped}<span className="text-sm font-normal text-gray-500 ml-1">\u4ef6</span>span></div>div><div className="text-xs text-gray-400">\u672c\u65e5\u5b8c\u4e86</div>div></div>div>
                                      </div>div>
                                      <div className="grid grid-cols-3 gap-6">
                                                <div className="col-span-2 bg-white rounded-xl shadow-sm p-5">
                                                            <h2 className="font-semibold mb-4">\u4eca\u65e5\u51fa\u8377\u3059\u308b\u4e00\u89a7 <span className="text-sm font-normal text-gray-500">\u6700\u7d42\u66f4\u65b0: {new Date().toLocaleTimeString('ja-JP', { hour: '2-digit', minute: '2-digit' })}</span>span></h2>h2>
                                            ...
                                            const it = o.order_items[0]
                                                                return <tr key={o.id} className={`border-b hover:bg-gray-50 ${selectedId === o.id ? 'bg-blue-50' : ''}`}>
                                                                                    ...
                                                                                    <td className="py-2">{o.status !== 'shipped' && o.status !== 'completed'
                                                                                                          ...
                                                                                                          : <span className="text-xs text-gray-400">\u767b\u9332\u6e08</span>span>}</td>td>
                                                                </tr>tr>
                                                                  })}
                                                                          </tbody>tbody>
                                                            </table>table>
                                                ...
                                                <div className="space-y-4">
                                                            <div className="bg-white rounded-xl shadow-sm p-5">
                                                              ...
                                                              {selectedId && <p className="text-xs text-blue-600 mb-2">\u9078\u629e\u4e2d: {orders.find(o => o.id === selectedId)?.order_no}</p>p>}
                                                                          <div className="space-y-3">
                                                                                          ...
                                                                                          <div><label className="text-xs text-gray-500 block mb-1">\u2461 \u8ffd\u8de1\u756a\u53f7\u3092\u5165\u529b</label>label>
                                                                                                            <input value={trackingNo} onChange={e => setTrackingNo(e.target.value)} placeholder="\u8ffd\u8de1\u756a\u53f7\u3092\u5165\u529b\u3057\u3066\u304f\u3060\u3055\u3044" className="w-full border rounded-lg px-3 py-2 text-sm" /></div>div>
                                                            ...
                                                            <div className="bg-blue-50 rounded-xl p-4 text-xs text-gray-700">
                                                                          <p className="font-medium mb-1">\u51fa\u8377\u30eb\u30fc\u30eb\uff1a\u5e73\u65e5</p>p>
                                                                          <p>12:00\u307e\u3067\u306e\u51fa\u8377\u767b\u9332\u3067\u3001\u7fcc\u65e5\u7d0d\u54c1\u3068\u306a\u308a\u307e\u3059\u3002</p>p>
                                                            </div>div>
                                                </div>div>
                                      </div>div>
                              </div>div>
